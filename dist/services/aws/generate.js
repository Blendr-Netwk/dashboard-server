...
exports.generateAwsPresignedUrl = void 0;
const main_1 = require("./main");
const generateAwsPresignedUrl = async (fileName, fileType) => {
    const s3Params = {
    ...
    const presignedUrl = await main_1.awsS3.getSignedUrlPromise('putObject', s3Params);
    return presignedUrl;
};
exports.generateAwsPresignedUrl = generateAwsPresignedUrl;
