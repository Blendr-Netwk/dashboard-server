...
exports.multerUpload = exports.memoryStorage = void 0;
const fs_1 = __importDefault(require("fs"));
const multer_1 = __importDefault(require("multer"));
const path_1 = __importDefault(require("path"));
const storage = multer_1.default.memoryStorage();
exports.memoryStorage = (0, multer_1.default)({ storage: storage });
const localStorage = multer_1.default.diskStorage({
    destination: function (req, file, cb) {
        // const mediaType = getMediaType(file.originalname);
        const dest = path_1.default.join('uploads/');
        // Check if directory exists, if not, create it
        if (!fs_1.default.existsSync(dest)) {
            fs_1.default.mkdirSync(dest, { recursive: true }); // recursive ensures all nested directories are created
        }
